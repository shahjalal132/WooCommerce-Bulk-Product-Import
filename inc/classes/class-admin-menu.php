                    ...
                    <form id="client-credentials-form">
                        <div class="d-flex align-items-center">
                            ...
                            <input type="text" class="form-control" style="width: 30% !important; margin-left: 4.7rem;"
                                name="client-id" id="client-id" value="<?php echo $client_id; ?>" placeholder="<?php _e( 'Client ID', 'bulk-product-import' ); ?>"
                                required>
                        </div>
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <input type="text" class="form-control ms-5" style="width: 30% !important" name="client-secret"
                                id="client-secret" value="<?php echo $client_secret; ?>" placeholder="<?php _e( 'Client Secret', 'bulk-product-import' ); ?>"
                                required>
                        </div>
